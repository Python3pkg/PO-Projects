...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TemplateMsg.flags'
        db.delete_column('po_projects_templatemsg', 'flags')

        # Adding field 'TemplateMsg.plural_message'
        db.add_column('po_projects_templatemsg', 'plural_message',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'TemplateMsg.flags'
        raise RuntimeError("Cannot reverse this migration. 'TemplateMsg.flags' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'TemplateMsg.flags'
        db.add_column('po_projects_templatemsg', 'flags',
                      self.gf('django.db.models.fields.TextField')(),
                      keep_default=False)

        # Deleting field 'TemplateMsg.plural_message'
        db.delete_column('po_projects_templatemsg', 'plural_message')
