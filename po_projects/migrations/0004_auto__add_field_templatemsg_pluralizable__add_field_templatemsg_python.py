...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('po_projects_templatemsg', 'pluralizable',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'TemplateMsg.python_format'
        db.add_column('po_projects_templatemsg', 'python_format',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('po_projects_templatemsg', 'pluralizable')

        # Deleting field 'TemplateMsg.python_format'
        db.delete_column('po_projects_templatemsg', 'python_format')
